...
Requires: boost root rootjs classlib-zip libuuid protobuf jemalloc
#Requires: yui extjs py2-CherryPy py2-Cheetah py2-pycurl py2-cjson py2-argparse py2-pytest py2-nose d3 rotatelogs
#BuildRequires: py2-sphinx gmake
...
dirs="$CLASSLIB_ZIP_ROOT $BOOST_ROOT $PYTHON_ROOT $ROOT_ROOT
      $ZLIB_ROOT $PCRE_ROOT $LIBPNG_ROOT $LIBJPEG_TURBO_ROOT $PROTOBUF_ROOT $JEMALLOC_ROOT"
for d in $dirs; do
  libs="$libs $d/lib $d/lib64"
  case $d in
    $PYTHON_ROOT )
